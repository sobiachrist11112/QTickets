...
public class EventDateAdapter extends RecyclerView.Adapter<EventDateAdapter.MyViewHolder> {
    ...
    public EventDateAdapter(List<EventBookingQT5Date> eventBookingQT5Dates, Context context,OnDateSelectListener onDateSelectListener,int selected_postion) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (selectedDatePosition == position){
            ...
            onDateSelectListener.onClickDate(holder.itemView,data.date);
