...
public class EventsListQT5Fragment extends Fragment implements View.OnClickListener , EventFragmentListContracter.View{
    ...
    public void callEventListApi(){
        ...
        switch (selection){
            case 0:{
                presenter.getAllEvents(CountryID, selected_cat_id,"","",selected_min_price,selected_max_price);
//                presenter.getAllEvents(-1,CategoryID,"","");
            }break;
            case 1:{
                presenter.getAllEvents(CountryID, selected_cat_id, DateTimeUtils.getTodayDate(),DateTimeUtils.getWeekLastDate(),selected_min_price,selected_max_price);
//                presenter.getAllEvents(-1,CategoryID, DateTimeUtils.getTodayDate(),DateTimeUtils.getWeekLastDate());
            }break;
            case 2:{
                presenter.getAllEvents(CountryID, selected_cat_id, DateTimeUtils.getTodayDate(),DateTimeUtils.getMonthLastDate(),selected_min_price,selected_max_price);
