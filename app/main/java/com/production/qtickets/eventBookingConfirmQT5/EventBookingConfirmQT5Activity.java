    ...
    private void listeners() {
        ...
        tv_help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("mailto:info@qtickets.com")); // only email apps should handle this
        ...
        ll_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle b = new Bundle();
                b.putString("webViewURL", "http://admine.q-tickets.com/Order/PrintTicket?pkId="+data.pkId);
                b.putString("pagename", "Download Ticket");
                Intent i = new Intent(getApplicationContext(), DownloadInvoiceWebView.class);
