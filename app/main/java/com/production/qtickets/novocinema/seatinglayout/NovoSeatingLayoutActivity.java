...
public class NovoSeatingLayoutActivity extends AppCompatActivity implements NovoSeatingContracter.View {
    ...
    //string
    String selectedtickettypes, cid, session_id, cencor, movie_title, mall_name, currency, usersessionId, show_date,
            duration, movie_type, movie_img_url, screenName, show_timimg, selected_ticket_cost, selectedtickettypeswithamount;
    //integer
...
//                            i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT|Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public void setNovoBlockSeating(NovoBlockSeatsModel novoBlockSeatsModel) {
        ...
        b.putString("MOVIE_DATE", show_date);
