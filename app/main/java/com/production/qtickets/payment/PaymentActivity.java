...
public class PaymentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
   ...
   /* @Override
    ...
    @OnClick({R.id.iv_back_arrow, R.id.visa, R.id.ams, R.id.doha, R.id.naps, R.id.paypal, R.id.btn_pay, R.id.cancel})
...
//        });
    ...
    private void checkout() {
        ...
        /*MasterpassCheckout.newInstance(PaymentActivity.this, APP_ID, MERCHANT_ID,
                APP_TOKEN, MOBILE_NUMBER,
                amount, CURRENCY,
                orderId, CORRELATION_ID, new CheckoutListener() {

                    @Override
                    public void onTransactionSuccess(Transaction transaction) {

                        Log.v("transaction_success", String.valueOf(transaction));

                      *//*  transactionStatusTextView.setText("Last Transaction: "
                                + Calendar.getInstance().getTime() + " - " + "Successful");
