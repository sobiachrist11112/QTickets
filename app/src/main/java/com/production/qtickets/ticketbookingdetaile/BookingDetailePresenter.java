...
public class BookingDetailePresenter implements BookingDetaileContracter.Presenter {
    ...
    @Override
    public void doSeatLockConfirmation(int wacharge, String transactionid) {
        try {
            APIClient.getClient()
                    .create(APIInterface.class)
                    .doSeatLock(transactionid, AppConstants.AppSource, wacharge, "1.0")
                    .enqueue(new Callback<List<BookingDetaileModel>>() {
                        @Override
                        public void onResponse(
                                @NonNull Call<List<BookingDetaileModel>> call, @NonNull retrofit2.Response<List<BookingDetaileModel>> response
    ...
    @Override
    public void donovoQticketsTicketConfirmation(String CinemId,
                                                 String CinemaName,
                                                 String MovieId,
                                                 String MovieName,
                                                 String MovieUrl,
                                                 ...
                                                 String Show_date,
                                                 String Show_time, String No_of_tickets,
                                                 String servicecharge,
                                                 String ticket_price,
                                                 String total_paid, String seats_info,
                                                 String seats_id) {
        try {
            APIClientQticketsNovo.getClient()
                    .create(APIInterface.class)
                    .getNovoConfirmation("insert_novoBooking", "0", CinemId, CinemaName, MovieId, MovieName,
                            MovieUrl, SessionId, bookingInfoId, userSessionID
                            , Show_date, Show_time, No_of_tickets,
                            servicecharge, ticket_price, total_paid, seats_info,
    ...
    public void doNovopay(String user_id, String CinemId, String CinemaName, String MovieId, String MovieName,
                          ...
                          String Show_date, String Show_time, String No_of_tickets, String serchr,
                          String ticket_price,
                          String total_paid, String seats_info, String seats_id, String BookingID,
                          String Customer_name, String Customer_phone, String Customer_email,
                          String Customer_prefix,
                          int waprice) {
        try {
            APIClientQticketsNovo.getClient()
                    .create(APIInterface.class)
                    .getNovoproceddtopay("update_novoBooking_whatsapp",
                            user_id, CinemId, CinemaName, MovieId, MovieName, MovieUrl, SessionId,
                            ...
                            , Customer_email, Customer_prefix, waprice)
                    .enqueue(new Callback<NovoBookingConfirmationModel1>() {
                        @Override
                        public void onResponse(
                                @NonNull Call<NovoBookingConfirmationModel1> call, @NonNull retrofit2.Response<NovoBookingConfirmationModel1> response
                        ) {
                            if (mView != null) {
                                mView.dismissPb();
                                if (response.isSuccessful() && response.body() != null) {
                        ...
                        @Override
                        public void onFailure(@NonNull Call<NovoBookingConfirmationModel1> call, @NonNull Throwable t) {
                            if (mView != null) {
                                mView.dismissPb();
                                mView.onFailure(call, t, this, null);
                            }
    ...
    @Override
    public void getWhatsAppPrice(String country) {
        try {
            APIClient.getClient()
                    .create(APIInterface.class)
                    .getWhatsAppPrice(country)
                    .enqueue(new Callback<List<WhatsAppChargeResponse>>() {
                        @Override
                        public void onResponse(
                                @NonNull Call<List<WhatsAppChargeResponse>> call, @NonNull retrofit2.Response<List<WhatsAppChargeResponse>> response
                        ) {
                            if (mView != null) {
                                mView.dismissPb();
                                if (response.isSuccessful() && response.body() != null) {
                                    if (response.body().size() > 0) {
                                        mView.setWhatsAppPrice(response.body().get(0));
                                    }
                                } else {
                                    mView.onFailure(call, null, this, null);
                                }
                        ...
                        @Override
                        public void onFailure(@NonNull Call<List<WhatsAppChargeResponse>> call, @NonNull Throwable t) {
                            if (mView != null) {
                                mView.dismissPb();
                                mView.onFailure(call, t, this, null);
                            }
