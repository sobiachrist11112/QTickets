...
public class BookingDetaileActivity extends AppCompatActivity implements BookingDetaileContracter.View, AdapterView.OnItemSelectedListener {
    ...
    @BindView(R.id.tvwhtsappmoview)
    TextView tvwhtsappmoview;

    @BindView(R.id.txt__whatsapp_charge)
    TextView txt__whatsapp_charge;
 ...
 /*   @BindView(R.id.tv_voucher_codes)
    ...
    String mMovie_name, mMall_Name, show_date, show_datetoView, mShow_ID, mMoviesCost, duration, movie_type, movie_img_url,
            selected_seats, perTicketPrice, new_perTicketPrice;

    int couponTotalValue;
    int totalDiscountValue = 0;
    int finalValue = 0;

    double whatsAppcharge = 0;
    ...
    public void setBlockSeat(List<BookingDetaileModel> bookingDetaileModels) {
        ...
        if (bookingDetaileModels.get(0).status.equals("True")) {
            ...
            txt__txt_total_payble_amount.setText((String.valueOf(Double.parseDouble(bookingDetaileModels.get(0).totalprice) + whatsAppcharge)) + " " + bookingDetaileModels.get(0).currency);
            btn_pay.setText(getString(R.string.pay) + " " + (Double.parseDouble(bookingDetaileModels.get(0).totalprice) + whatsAppcharge) + " " + bookingDetaileModels.get(0).currency);
    ...
    public void setSeatLock(List<BookingDetaileModel> bookingDetaileModels) {
        if ((bookingDetaileModels.get(0).status.equalsIgnoreCase("True"))) {
            ...
            if (whatsappChecked)
                presenter.doSeatLockConfirmation(1, str_transaction_id);
            else
                presenter.doSeatLockConfirmation(0, str_transaction_id);
        } else if (bookingDetaileModels.get(0).errormsg.equals("Please Enter Valid Mobile Number")) {
            QTUtils.showDialogbox(this, bookingDetaileModels.get(0).errormsg.toString());
            dismissPb();
        } else if (bookingDetaileModels.get(0).errormsg.equals("Please Enter Valid email address")) {
            QTUtils.showDialogbox(this, bookingDetaileModels.get(0).errormsg.toString());
            dismissPb();
        } else if (bookingDetaileModels.get(0).errormsg.equals("Seats Are Already Booked Please Select Another Seats")) {
            QTUtils.showDialogbox(this, bookingDetaileModels.get(0).errormsg.toString());
            dismissPb();
        } else {
            // showPb();
    ...
    public void getMessage(Events.DiscountTotalMessage discountTotalMessage) {
     ...
     /*   Log.v("discountTotalMessage","== "+discountTotalMessage.getDiscountPrice());
        ...
        if (couponTotalValue > 0) {
            ...
            txt__txt_total_payble_amount.setText((finalValue + whatsAppcharge) + " " + currency);
            btn_pay.setText(getString(R.string.pay) + " " + (finalValue + whatsAppcharge) + " " + currency);
    ...
    public void setCouponCode(List<BookingDetaileModel> bookingDetaileModels) {
        if (bookingDetaileModels.get(0).status.equals("true")) {
            ...
            if (Integer.parseInt(total_price) > totalDiscountValue) {
                txt__txt_total_payble_amount.setText(String.valueOf(Double.parseDouble(total_price + whatsAppcharge) - totalDiscountValue) + " " + currency);
                btn_pay.setText(getString(R.string.pay) + " " + String.valueOf(Double.parseDouble(total_price + whatsAppcharge) - totalDiscountValue) + " " + currency);
                sessionManager.setDiscountAmount(String.valueOf(totalDiscountValue));
                finalValue = Integer.parseInt(total_price + whatsAppcharge) - totalDiscountValue;
            } else {
            ...
            txt__txt_total_payble_amount.setText((total_price + whatsAppcharge) + " " + sessionManager.getCountryCurrency());
            btn_pay.setText(getString(R.string.pay) + " " + (Double.parseDouble(total_price) + whatsAppcharge) + " " + sessionManager.getCountryCurrency());
    ...
    public void setSeatLockConfirmation(@NonNull List<BookingDetaileModel> bookingDetaileModels) {
        if (bookingDetaileModels.get(0).status.equals("True")) {
            ...
            Log.d("8Nov:" + " setSeatLock", bookingDetaileModels.get(0).balance);
...
//                        startActivity(i);
            ...
            if (whatsappChecked)
                ...
                presenter.doSeatLockConfirmation(0, str_transaction_id);
            Log.d("310ct", "whatsAppcharge:" + whatsAppcharge);
    ...
    public void setnovoQticketsTicketConfirmation(NovoBookingConfirmationModel novoBookingConfirmationModel) {
        if (novoBookingConfirmationModel.status.equals("1")) {
            if (novoBookingConfirmationModel.arrayData.table.size() > 0) {
                ...
                Log.d("21dec", "setnovo:" + booking_id);

                txt__total_price.setText(String.valueOf(amount) + " " + currency);
                Double total_amount = 0.0;

                if (whatsappChecked)
                    total_amount = amount + servicecharge + whatsAppcharge;

                else
                    total_amount = amount + servicecharge;

                str_novo_total_amount = String.valueOf(total_amount);
                Log.d("14Nov:", "QticketsTicketConfirmation" + str_novo_total_amount);
                txt__txt_total_payble_amount.setText(String.valueOf(str_novo_total_amount) + " " + currency);
                btn_pay.setText(getString(R.string.pay) + " " + String.valueOf(str_novo_total_amount) + " " + currency);
    ...
    public void setNovoCouponCode(List<BookingDetaileModel> bookingDetaileModel) {
        ...
        if (bookingDetaileModel.get(0).status.equals("true")) {
            ...
            if (Integer.parseInt(total_price) > totalDiscountValue) {
                ...
                txt__txt_total_payble_amount.setText(String.valueOf(Integer.parseInt(total_price + whatsAppcharge) - totalDiscountValue) + " " + currency);
                btn_pay.setText(getString(R.string.pay) + " " + String.valueOf(Integer.parseInt(total_price + whatsAppcharge) - totalDiscountValue) + " " + currency);
                sessionManager.setDiscountAmount(String.valueOf(totalDiscountValue));
            ...
            str_voucher_code = "null";
            txt__txt_total_payble_amount.setText((total_price + whatsAppcharge) + " " + sessionManager.getCountryCurrency());
            btn_pay.setText(getString(R.string.pay) + " " + (total_price + whatsAppcharge) + " " + sessionManager.getCountryCurrency());
            str_novo_total_amount = total_price + whatsAppcharge;
            Log.d("14Nov:", "else coupon" + str_novo_total_amount);
    ...
    @Override
    public void setNovoPay(NovoBookingConfirmationModel1 novoBookingConfirmationModel) {
        if (novoBookingConfirmationModel.status.equals("1")) {
            showPb();
            if (str_voucher_code.equals("null")) {
                ...
                b.putString("phonenumber", edt_phone_number.getText().toString());
                if (whatsappChecked)
                    b.putString("whatsappChecked", "1");
                else
                    b.putString("whatsappChecked", "0");

                Log.d("30Oct:", "setNovoPay Amount: " + str_novo_total_amount);
                Log.d("14Nov:", "setNovoPay" + str_novo_total_amount);
    ...
    public void setNovoUpdateCouponCode(BookingDetaileModel bookingDetaileModel) {
        if (bookingDetaileModel.status.equals("valid")) {
            ...
            if (balance.equalsIgnoreCase("0")) {
                ...
                Bundle b = new Bundle();
                b.putString("OrderInfo", String.valueOf(booking_id));
                Log.d("8Nov: else", "balance " + balance);
                ...
                Log.d("14Nov:", "setNovoUpdateCouponCode Amount: " + str_novo_total_amount);
    ...
    @Override
    public void setWhatsAppPrice(WhatsAppChargeResponse whatsAppPrice) {

        Log.d("22dec", "setWhatsAppPrice :");

        if (whatsAppPrice.status.equals("true")) {
            whatsAppcharge = Double.parseDouble(whatsAppPrice.price);

            Log.d("22dec", "whatsAppcharge :" + whatsAppcharge);

            txt__whatsapp_charge.setText(whatsAppcharge + "  " + whatsAppPrice.currency);
            tvwhtsappmoview.setVisibility(View.VISIBLE);
            txt__whatsapp_charge.setVisibility(View.VISIBLE);
//            view2.setVisibility(View.VISIBLE);
            cb_whatsapp.setChecked(true);
        } else {
            tvwhtsappmoview.setVisibility(View.GONE);
            txt__whatsapp_charge.setVisibility(View.GONE);
//            view2.setVisibility(View.GONE);
        ...
        if (str_differ.equals("qtickets")) {
            ...
            for (int i = 0; i < ticket_list.size(); i++) {
                if (ticket_list.get(i).ticketcount > 0 && Double.parseDouble(ticket_list.get(i).ticketPrice) <= 75.00) {
                ...
                } else if (ticket_list.get(i).ticketcount > 0 && Double.parseDouble(ticket_list.get(i).ticketPrice) > 75.00 && Double.parseDouble(ticket_list.get(i).ticketPrice) <= 150) {
                    servicecharge = servicecharge + ticket_list.get(i).noOfSeats * 8.00;
                    servicecharge = Math.ceil(servicecharge);
                    txt__service_charge.setText(String.valueOf(servicecharge) + " " + currency);

                } else if (ticket_list.get(i).ticketcount > 0 && Double.parseDouble(ticket_list.get(i).ticketPrice) > 150.00) {

                    double t_amount = Double.parseDouble(ticket_list.get(i).ticketPrice);
                    servicecharge = servicecharge + ((t_amount * mSelectedSeatsList.size()) / 100.0f * 5);
                    servicecharge = Math.ceil(servicecharge);
                    txt__service_charge.setText(String.valueOf(servicecharge) + " " + currency);
            ...
            str_novo_total_amount = String.valueOf(total_amount);
            txt__txt_total_payble_amount.setText(String.valueOf(total_amount + whatsAppcharge) + " " + currency);
            btn_pay.setText(getString(R.string.pay) + " " + String.valueOf(total_amount + whatsAppcharge) + " " + currency);
    ...
    public void init() {
        ...
        if (b != null) {
            ...
            show_datetoView = b.getString("MOVIE_DATE");
            show_date = b.getString("MOVIE_DATE_TOSEND");
            mSelectedSeatsList = b.getStringArrayList("TOTAL PERSON");
            display_status = b.getString("display_status");
            for (String city : mSelectedSeatsList) {
                csvBuilder.append(city);
                csvBuilder.append(SEPARATOR);
            }

            Log.d("21dec", "show_date RRR:" + show_date);
...
//        }
        ...
        presenter.getWhatsAppPrice(sessionManager.getCountryName());

        Log.d("22dec", "str_differ :" + str_differ);

        if (str_differ.equals("qtickets")) {

            mShow_ID = b.getString("MOVIE_SHOW_TIME_ID");

            if (display_status.equals("3")) {
                String[] arrayOptions = show_time.split(":");
                int showstime = Integer.parseInt(arrayOptions[0]);
                String showtime = showstime < 12 ? "Morning" : "Evening";
                String incementdate = incrementDateByOne(show_datetoView, true, showtime);

                txtMovieDate.setText(incementdate);
                ...
                String incementdate = incrementDateByOne(show_datetoView, false, showtime);
                txtMovieDate.setText(incementdate);
            ...
            try {
                ...
                Date inputDate = inputDateFormat.parse(show_datetoView);
                Calendar calendar = Calendar.getInstance();
                calendar.setTime(inputDate);
                int dayOfWeek = calendar.get(Calendar.DAY_OF_WEEK);
                formateed = new SimpleDateFormat("EEEE", Locale.ENGLISH).format(calendar.getTime());

            } catch (ParseException e) {
                e.printStackTrace();
            }

            txtMovieDate.setText(formateed + "," + " " + show_datetoView);
            ...
            cid = b.getString("cid");
            ticket_list = (List<TicketlistModel>) b.getSerializable("ticketlist");

            Log.d("21dec", "show_date:" + show_date);

//          08 Sep, 2023

            showPb();
            presenter.donovoQticketsTicketConfirmation(cid,
                    mMall_Name,
                    sessionManager.getMovieId(),
                    mMovie_name,
                    movie_img_url,
                    session_id,
                    booking_info_id,
                    userSessionID,
                    show_date,
                    show_time, String.valueOf(mSelectedSeatsList.size()),
                    String.valueOf(servicecharge), String.valueOf(booking_total_price_value),
                    String.valueOf(booking_total_price_value),
                    selected_ticket_info, seat_list);
       ...
       /* if (sessionManager.getNumber().contains("")) {
            String[] phone = sessionManager.getNumber().split(" ");
            if (phone.length == 2) {
                edt_phone_number.setText(phone[1]);
            }
            if (phone.length > 2) {
                edt_phone_number.setText(phone[1] + phone[2]);
            }
        } else {
            edt_phone_number.setText(sessionManager.getNumber());
        }*/

      /*  if (!sessionManager.getNumber().isEmpty()){
            edt_phone_number.setText(sessionManager.getNumber());
            //set here...
        ...
        cb_whatsapp.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
...
//                    view2.setVisibility(View.VISIBLE);
                    ...
                    String[] totalpayableamount = txt__txt_total_payble_amount.getText().toString().split(" ");
                    double finalprice = Double.parseDouble(totalpayableamount[0]) + whatsAppcharge;
                    txt__txt_total_payble_amount.setText(String.valueOf(finalprice) + " " + sessionManager.getCountryCurrency());
                    btn_pay.setText(String.valueOf(finalprice) + " " + sessionManager.getCountryCurrency());

                    str_novo_total_amount = String.valueOf(finalprice);
                    Log.d("14Nov:", "Checked" + finalprice);
...
//                  view2.setVisibility(View.GONE);
                    ...
                    Log.d("14Nov:", "Checked Not" + finalprice);
    ...
    public String incrementDateByOne(String inputDateStr, boolean isIncrementRequired, String showtime) {
        String date = "";
        String inputDateFormatStr = "yyyy-MM-dd";
        String outputDateFormatStr = "EEEE dd-MMM-yyyy";
        ...
        try {
            ...
            date = String.format("%s %s", outputFormat.format(incrementedDate), showtime);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return date;
                                        ...
                                        if (status) {
                                            if (terms_checkbox.isChecked()) {
                                                if (str_differ.equals("qtickets")) {
                                                    ...
                                                    Log.d("21dec", "booking_id:" + booking_id);
                                                    ...
                                                    if (whatsappChecked) {
                                                        presenter.doNovopay(user_id, cid, mMall_Name, sessionManager.getMovieId()
                                                                ...
                                                                String.valueOf(mSelectedSeatsList.size()), String.valueOf(servicecharge),
                                                                str_novo_total_amount, str_novo_total_amount
                                                                , selected_ticket_info, seat_list, String.valueOf(booking_id), edt_name.getText().toString(),
