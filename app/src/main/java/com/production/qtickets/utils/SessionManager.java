...
public class SessionManager {
    ...
    private final static String MOVIES_CAT_LIST = "moview_catlist";
    ...
    private final static String CONTACTUSEMAILFORDUBAI = "contactemailfordubai";
    private final static String CONTACTUSEMAILFORQATAR = "contactemailforqatar";

    private final static String CONTACTUSEMAILFORBEHRAIN = "contactemailforbehrain";
    private final static String CONTACTSUSPHONEDUBAI = "contactphonedubai";
    private final static String CONTACTSUSPHONEBEHRAIN = "contactphonebehrain";
    ...
    public String getContactEmailForDubai() {
        String device_token = pref.getString(CONTACTUSEMAILFORDUBAI, "");
        return device_token;
    }

    public void setContactEmailForDubai(String faq) {
        editor.putString(CONTACTUSEMAILFORDUBAI, faq);
        editor.commit();

    }

    public void setContactEmailForQatar(String faq) {
        editor.putString(CONTACTUSEMAILFORQATAR, faq);
        editor.commit();

    }

    public String getContactEmailForQatar() {
        String device_token = pref.getString(CONTACTUSEMAILFORQATAR, "");
        return device_token;
    }


    public String getBehrainContactPhone() {
        String device_token = pref.getString(CONTACTSUSPHONEBEHRAIN, "");
        return device_token;
    }

    public void setBehrainContactPhone(String faq) {
        editor.putString(CONTACTSUSPHONEBEHRAIN, faq);
        editor.commit();

    }

    public void setContactEmailForBehrain(String faq) {
        editor.putString(CONTACTUSEMAILFORBEHRAIN, faq);
        editor.commit();

    }

    public String getContactEmailForBehrain() {
        String device_token = pref.getString(CONTACTUSEMAILFORBEHRAIN, "");
        return device_token;
    }
  ...
  /*  public void setCatList(ArrayList<CustomModel> catList) {
        Set<CustomModel> stringSet = new HashSet<>(catList);
        editor.putStringSet(MOVIES_CAT_LIST, stringSet);
        editor.commit();
    }

    public  ArrayList<CustomModel>  getCatList() {
        Set<CustomModel> stringSet = pref.getStringSet(MOVIES_CAT_LIST, new HashSet<>());
    ...
    public void setCatList(ArrayList<CustomModel> catList) {
        ...
        editor.putString(MOVIES_CAT_LIST, json);
        editor.apply();
    }

    public ArrayList<CustomModel> getCatList() {
        String json = pref.getString(MOVIES_CAT_LIST, "");
        if (json.isEmpty()) {
            return new ArrayList<>(); // Return an empty list if no data is found
        }

        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<CustomModel>>() {
        }.getType();
