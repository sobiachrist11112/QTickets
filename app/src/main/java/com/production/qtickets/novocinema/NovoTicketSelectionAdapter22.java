...
public class NovoTicketSelectionAdapter22 extends RecyclerView.Adapter<NovoTicketSelectionAdapter22.MyViewHolder> {
    ...
    public NovoTicketSelectionAdapter22(Context context, List<TicketlistModel> nList, String str_max_tickets, TextView txtNoOfTickets, TextView txtTotalAmount,onTicketsChangedListener mListener) {
        this.nList = nList;
...
//                if(!nList.get(position).isAlreadySelected){
//                    increaseCount(m_list, holder, position);
//                    nList.get(position).isAlreadySelected=true;
//                   // resetThefirstone(holder);
//                }    else {
//                    nList.get(position).isAlreadySelected=false;
//                }
