...
public class NovoTicketSelectionActivity extends AppCompatActivity implements NovoTicketSelectionContracter.View {
    ...
    private String str_movie_title, str_mall_name, cid, session_id, str_max_tickets, cencor,
            duration, movie_type, movie_img_url, screenName, screenType, showTime,showDate;
    //layoutmanager
    LinearLayoutManager rec_linear_layout_manager;
    //adapter
    NovoTicketSelectionAdapter adapter;
    NovoTicketSelectionAdapter22 adapter22;
    //list
    ...
    public void setNovoTicketSelection(NovoTicketSeletionModel novoTicketSeletionModels) {
        ...
        if (maxtickets != 0) {
            ...
            if (ticketlist.size() > 0) {
                ...
                if (screenType.toUpperCase().contains("MAJLIS")) {
                    ...
                    adapter22= new NovoTicketSelectionAdapter22(NovoTicketSelectionActivity.this, ticketlist, str_max_tickets, txtNoOfTickets, txtTotalAmount, new NovoTicketSelectionAdapter22.onTicketsChangedListener() {
                        @Override
                        public void ticketsCount(int noOfTickets, int noOfPerson) {
                            no_of_tickets = noOfPerson;
                        }
                    });
                    recTicketType.setAdapter(adapter22);
//
                }
    ...
    public void init() {
        ...
        if (b != null) {
            ...
            showDate = b.getString("show_date");
        }
...
//                            no_of_tickets = no_of_tickets + ticketlist.get(i).ticketcount; //commented by sudhir
                    ...
                    if (!TextUtils.isEmpty(selectedtickettypes)) {
                        // + (ticketlist.get(i).ticketcount*ticketlist.get(i).adm
                        Bundle b = new Bundle();
                        ...
                        b.putString("show_date", showDate);
