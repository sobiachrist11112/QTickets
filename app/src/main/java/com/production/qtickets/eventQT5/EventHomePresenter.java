...
public class EventHomePresenter implements EventHomeContracter.Presenter{
    ...
    @Override
    public void getCarouselBanners(int countryID,String categoryID) {
        try{
            if (mView != null)mView.showPb();
            APIClient.getClientQT5().create(APIInterface.class).getCarouselBanners(AppConstants.Authorization_QT5,countryID,categoryID)
    ...
    @Override
    public void  getCarouselBannersAgain(int countryID,String categoryID) {
        try{
            if (mView != null)mView.showPb();
            APIClient.getClientQT5().create(APIInterface.class).getCarouselBanners(AppConstants.Authorization_QT5,countryID,categoryID)
                    .enqueue(new Callback<CarouselBannerModel>() {
                        ...
                        public void onResponse(
                            ...
                            if (mView != null) {
                                mView.dismissPb();
                                if (response.isSuccessful() && response.body() != null) {
                                    mView.setCarouselBannersAgain(response.body());
                                } else {
                                    mView.onFailure(call, null, this, null);
                                }
                            }
