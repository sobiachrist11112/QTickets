...
public class EventsListQT5Adapter extends RecyclerView.Adapter<EventsListQT5Adapter.EventsListViewHolder> {

    List<AllEventQT5Data> eventListArrayList;
    Context context;
    SessionManager sessionManager;

    public EventsListQT5Adapter(Context context, List<AllEventQT5Data> eventListArrayList) {
    ...
    public EventsListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.events_list_item_qt5_row,parent,false);
        return new EventsListQT5Adapter.EventsListViewHolder(itemView);
    }
...
//                    Bundle b = new Bundle();
//                    b.putString("url", eventData.webViewUrl+"?webview=true");
//                    b.putString("pagename", eventData.eventTitle);
//                    Intent i = new Intent(context, EventWebViewSecond.class);
//                    i.putExtras(b);
//                    context.startActivity(i);
