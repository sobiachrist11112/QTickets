...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(searchItems.get(position).webViewUrl.contains("https://events.q-tickets.com")){
            holder.iv_datatype.setImageResource(R.drawable.ic_events);
        }else {
            holder.iv_datatype.setImageResource(R.drawable.ic_movie_red);
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            iv_datatype = itemView.findViewById(R.id.iv_datatype);
