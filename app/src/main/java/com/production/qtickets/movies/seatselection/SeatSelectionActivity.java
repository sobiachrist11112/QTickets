...
//              intent.putExtra("show_datetoview", show_datetoview);
                ...
                intent.putExtra("display_status", display_status);
...
//        }
        ...
        if (display_status.equals("3")) {
            date.setText(incrementDateByOne(show_date));
        } else {
...
//                        "أنت تحاول حجز فيلم تصنيفه 18+ يمنع الدخول لمن تقل اعمارهم عن 18 ويحتفظ مشرف السينما بالحق في رفض دخول الفيلم دون إرجاع سعر التذكرة في حال مخالفة القوانين.\n";
                str18 = "\n" + "\n" + getResources().getString(R.string.eighteen_plus_onlyarabictext) + "\n" + "\n";
                showDialogbox(this, sessionManager.getAgeRistrict() + "\n" + "\n" +
                        str18);

            } else if (sessionManager.getCensor().equals("PG 15")) {
                strPg = "\n" + "\n" + getResources().getString(R.string.pg_15arabictext) + "\n" + "\n";
                showDialogbox(this, sessionManager.getAgeRistrict() + "\n" + "\n" +
                        strPg);
//                strPg = "\n" +
//                        "\n" +
...
//                        strPg);
                ...
                str15 = "\n" + "\n" + getResources().getString(R.string.fifteenplus_onlyarabictext) + "\n" + "\n";
                showDialogbox(this, sessionManager.getAgeRistrict() + "\n" + "\n" +
                        str15);
            } else if (sessionManager.getCensor().equals("PG 13")) {
                str13 = "\n" + "\n" + getResources().getString(R.string.pg_13arabictext) + "\n" + "\n";
                showDialogbox(this, sessionManager.getAgeRistrict() + "\n" + "\n" +
                        str13);
            } else if (sessionManager.getCensor().equals("PG")) {
                pg = "\n" + "\n" + getResources().getString(R.string.pg_onlyarabictext) + "\n" + "\n";
                showDialogbox(this, sessionManager.getAgeRistrict() + "\n" + "\n" +
                        pg);
