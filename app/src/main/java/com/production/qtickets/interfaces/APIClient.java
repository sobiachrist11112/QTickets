...
public class APIClient {
    ...
    public static final String PAYMENT_BASE_URL_QT5_FOR_MOVIE = "https://www.q-tickets.com";

    // Live productions Urls
//     public static final String BASE_URL_QT5_EVENT = "https://apie.q-tickets.com/";
    public static final String BASE_URL_QT5_EVENT = "https://verifyapi.q-tickets.com/"; //verify local Url

    public static final String PAYMENT_URL = "https://verifyadmin.q-tickets.com"; //local
//     public static final String PAYMENT_URL = "https://admine.q-tickets.com";//live
    // need to change the payment url also for events .
