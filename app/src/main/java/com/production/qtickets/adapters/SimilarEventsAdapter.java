    ...
    public void onBindViewHolder(SimilarEventsAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!mSimilarEventList.get(position).isWebView){
                    context.finish();
                    ...
                    Bundle b = new Bundle();
                    b.putString("webViewURL", mSimilarEventList.get(position).webViewUrl);
                    b.putString("pagename", mSimilarEventList.get(position).eventTitle);
